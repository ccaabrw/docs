...
It wasn;t clear whether robocopy would be able to handle this cleanly, so use PowerShell instead.
...
To subsequently prune the empty folders, we use a recursive function from here:
